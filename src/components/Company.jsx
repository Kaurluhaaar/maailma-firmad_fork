            ...
            <div className="w-fit p-10 h-screen overflow-hidden">
                <div className="pl-5 min-w-600">
                    <a href={`https://${company.domain}`} className="flex">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" onClick={handleClose} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#C6C5E6" className="w-6 h-6">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" />
                        </svg>
                    <div className="flex space-x-6 p-2 bg-black">
                    ...
                    <div className="flex min-w-min mt-5 pb-16">
                        <div className="w-5 h-100 bg-gradient-to-b from-morning-blue to-space-blue"></div>
                        <div className="text-text-blue h-80 px-8 overflow-y-auto">{company.description}</div>
                    </div>

...
function Company({ html, company }) {
    ...
    return (
        <>
            <div className="w-fit mx-10 h-screen flex flex-col justify-center overflow-clip">
                <div>
                ...
                <div className="flex mt-10">
                    <div className="mr-12 w-1/2">
                        ...
                        <div className="flex my-6">
                            <div className="text-text-blue h-80 mt-5 px-8 mb-16 overflow-y-auto">{company.description}</div>
                            <div className="w-4 h-100 bg-gradient-to-b from-morning-blue to-space-blue"></div>
                        </div>
                        <div className="flex gap-3 pr-8 justify-end">
